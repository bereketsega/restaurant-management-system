...
public class CustomerQuery {
    public static String createCustomer(int customerID, String customerFName, String customerLName, String customerSSN, String customerPhone, String customerAddress) {
